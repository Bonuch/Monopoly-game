<template>
    <ul class="fullprofile__socials">
        <li class="fullprofile__socials-item" v-if="isVip">
            <a class="fullprofile__socials-link fullprofile__socials-vip" href="#">
                <svg class="fullprofile__socials-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                     viewBox="0 0 512 512">
        ...
        <li class="fullprofile__socials-item" v-if="facebookUrl">
            <a class="fullprofile__socials-link fullprofile__socials-fb"
               :href="facebookUrl" target="_blank">
                <img src="/design/icons/socials/facebook_gray.svg" alt="">
            </a>
        </li>

        <li class="fullprofile__socials-item" v-if="vkontakteUrl">
            <a class="fullprofile__socials-link fullprofile__socials-vk"
               :href="vkontakteUrl" target="_blank">
                <img src="/design/icons/socials/vk_gray.svg" alt="">
            </a>
        </li>
        <li class="fullprofile__socials-item" v-if="instagramUrl">
            <a class="fullprofile__socials-link fullprofile__socials-instagram"
               :href="instagramUrl" target="_blank">
                <img src="/design/icons/socials/instagram_gray.svg" alt="">
