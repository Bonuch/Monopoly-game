<template>
    <button type="button" class="user-profile-visibility-toggler" @click="toggleVisibility">
        <template v-if="!visibility">
            <svg width="20px" height="20px" class="user-profile-visibility-toggler__icon"
...
<script>
    export default {
        name: "UserProfileVisibilityToggler",
        props: {
            hiddenFields: Array,
            propName: {
                type: String,
        ...
        methods: {
            initProp() {
                for (let i = 0; i < this.hiddenFields.length; i++) {
                    if (this.hiddenFields[i] === this.propName) {
            ...
            toggleVisibility() {
                ...
                this.$emit('visibility-toggle', this.visibility, this.propName);
            }
        },
        mounted() {
            this.initProp();
...
<style lang="scss" scoped>
    .user-profile-visibility-toggler {
        ...
        &:active,
        &:focus {
            .user-profile-visibility-toggler__icon {
