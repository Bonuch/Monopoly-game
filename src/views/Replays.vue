<template>
  <div class="page-replays">
    ...
    <div class="games-spectator">
      <BaseTitle>
        <h1 class="games-spectator__title">Игры для наблюдения</h1>
      </BaseTitle>
      ...
      <BaseButton @click="updateList">Обновить</BaseButton>
...
export default {
  ...
  watch: {
    getUpdateMark: function (newVal){
      alert("i'm updated")
      alert(newVal)
      if (newVal){
        this.updateList()
        this.setUpdateMark(false)
      }
    }
  },
  mounted() {
